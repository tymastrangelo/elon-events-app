...
export default function MyRsvpdEventsScreen() {
  ...
  const { rsvpdEvents, allEvents, loading: userLoading } = useUser();
          ...
          <View style={styles.emptyContainer}>
            {userLoading ? (
              ...
              <Text style={styles.emptyState}>
                {activeTab === 'Upcoming' ? "You haven't RSVP'd to any upcoming events." : "No past RSVP'd events."}
              </Text>
            )}
          </View>
        }
